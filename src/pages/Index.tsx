...
function ValuePropBanner() {
  ...
  return (
    <div className="w-full flex items-center justify-between gap-3 px-4 py-2 text-xs font-mono"
    ...
    <div className="min-h-screen bg-background">
      ...
      {showHero && (
        <div className="relative">
          ...
          <button
            onClick={dismissHero}
            className="absolute top-4 right-4 p-1.5 rounded-lg bg-surface-2/80 hover:bg-surface-3 text-muted-foreground hover:text-foreground transition-colors text-xs font-mono flex items-center gap-1"
          >
      ...
      <footer className="border-t border-border mt-12 py-8 px-4 md:px-6">
        <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-sm text-muted-foreground font-mono">© 2026 GAINN — Global AI News Network. Powered by 100+ autonomous AI agents.</div>
